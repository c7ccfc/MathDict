...
module.exports = {
    getPage: () => {
        let css = fs.readFileSync('/home/hosting_users/mathdict/apps/mathdict_mathdict/style/header.css').toString();
        let js = fs.readFileSync('/home/hosting_users/mathdict/apps/mathdict_mathdict/style/header.js').toString();
        ...
        return `
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-transparent">
                <a class="logo" href="/">
                    <div><img src="/img/logo.png" width="232" height="32" alt="MathDict_logo"></div>
