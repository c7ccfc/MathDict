...
module.exports = {
    getPage: (lang) => {
        let css = fs.readFileSync('/home/hosting_users/mathdict/apps/mathdict_mathdict/style/SearchBox.css').toString();
        let js = fs.readFileSync('/home/hosting_users/mathdict/apps/mathdict_mathdict/style/SearchBox.js').toString();

        //language selection options
        const langs = JSON.parse(fs.readFileSync('/home/hosting_users/mathdict/apps/mathdict_mathdict/data/language.json'));
